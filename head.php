...
<html>
    <head>
        <script src="includes/jumboFiles/assets/js/color-modes.js"></script>

        <meta charset="utf-8">
        <meta name="description" content="OneQRiD Welcome Page">
        <meta name='viewport' content='width= device-width, initial-scale= 1.0'>

        <!-- Style using Bootstrap -->
        <link rel="canonical" href="https://getbootstrap.com/docs/5.3/examples/jumbotron/">
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@docsearch/css@3">
        <link href="/includes/jumboFiles/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
        ...
        <script>
            console.log ("Javascript code to write Text in the console");    
        </script>
